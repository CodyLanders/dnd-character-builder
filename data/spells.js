...
DND_DATA.supportedSpellSelectionClasses = ["wizard", "cleric", "druid"];
...
DND_DATA.spells = [
  ...
  { id: "charm-person", name: "Charm Person", level: 1, school: "Enchantment", castingTime: "1 action", range: "30 ft.", components: "V, S", duration: "1 hour", concentration: false, ritual: false, summary: "Make a humanoid regard you as friendly for a while.", classLists: ["wizard", "druid"] },
  ...
  { id: "detect-magic", name: "Detect Magic", level: 1, school: "Divination", castingTime: "1 action", range: "Self", components: "V, S", duration: "10 minutes", concentration: true, ritual: true, summary: "Sense nearby magic and learn its school.", classLists: ["wizard", "cleric", "druid"] },
  ...
  { id: "fog-cloud", name: "Fog Cloud", level: 1, school: "Conjuration", castingTime: "1 action", range: "120 ft.", components: "V, S", duration: "1 hour", concentration: true, ritual: false, summary: "Fill an area with thick fog that blocks sight.", classLists: ["wizard", "druid"] },
  ...
  { id: "jump", name: "Jump", level: 1, school: "Transmutation", castingTime: "1 action", range: "Touch", components: "V, S, M", material: "A grasshopper's hind leg", duration: "1 minute", concentration: false, ritual: false, summary: "Greatly increase a creature's jumping distance.", classLists: ["wizard", "druid"] },
  { id: "longstrider", name: "Longstrider", level: 1, school: "Transmutation", castingTime: "1 action", range: "Touch", components: "V, S, M", material: "A pinch of dirt", duration: "1 hour", concentration: false, ritual: false, summary: "Increase a creature's walking speed.", classLists: ["wizard", "druid"] },
  ...
  { id: "thunderwave", name: "Thunderwave", level: 1, school: "Evocation", castingTime: "1 action", range: "Self", components: "V, S", duration: "Instantaneous", concentration: false, ritual: false, summary: "Release a burst of thunderous force around you.", classLists: ["wizard", "druid"] },
  ...
  { id: "animal-friendship", name: "Animal Friendship", level: 1, school: "Enchantment", castingTime: "1 action", range: "30 ft.", components: "V, S, M", material: "A morsel of food", duration: "24 hours", concentration: false, ritual: false, summary: "Convince a beast that you mean it no harm.", classLists: ["domain", "druid"] },
  ...
  { id: "cure-wounds", name: "Cure Wounds", level: 1, school: "Evocation", castingTime: "1 action", range: "Touch", components: "V, S", duration: "Instantaneous", concentration: false, ritual: false, summary: "Heal a creature you touch.", classLists: ["cleric", "druid"] },
  ...
  { id: "faerie-fire", name: "Faerie Fire", level: 1, school: "Evocation", castingTime: "1 action", range: "60 ft.", components: "V", duration: "1 minute", concentration: true, ritual: false, summary: "Outline creatures and objects in magical light.", classLists: ["domain", "druid"] },
  ...
  { id: "healing-word", name: "Healing Word", level: 1, school: "Evocation", castingTime: "1 bonus action", range: "60 ft.", components: "V", duration: "Instantaneous", concentration: false, ritual: false, summary: "Heal a creature at range with a brief divine word.", classLists: ["cleric", "druid"] },
  ...
  { id: "speak-with-animals", name: "Speak with Animals", level: 1, school: "Divination", castingTime: "1 action", range: "Self", components: "V, S", duration: "10 minutes", concentration: false, ritual: true, summary: "Communicate simple ideas with beasts.", classLists: ["domain", "druid"] },
];
...
DND_DATA.getPreparedSpellLimit = function getPreparedSpellLimit(classId, abilities = {}, level = 1) {
  if (classId !== "cleric" && classId !== "druid") return 0;
