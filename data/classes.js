    ...
    groups: [
      {
        ...
        options: [
          { id: "aberrations", name: "Aberrations", description: "Alien or unnatural creatures" },
          { id: "beasts", name: "Beasts", description: "Natural animals" },
          { id: "celestials", name: "Celestials", description: "Divine beings" },
          { id: "constructs", name: "Constructs", description: "Animated objects or machines" },
          { id: "dragons", name: "Dragons", description: "Dragons and dragon-like creatures" },
          { id: "elementals", name: "Elementals", description: "Fire, water, earth, or air beings" },
          { id: "fey", name: "Fey", description: "Magical nature spirits" },
          { id: "fiends", name: "Fiends", description: "Demons, devils, and evil outsiders" },
          { id: "giants", name: "Giants", description: "Giants, ogres, and trolls" },
          { id: "monstrosities", name: "Monstrosities", description: "Strange or unnatural monsters" },
          { id: "oozes", name: "Oozes", description: "Slimes and amorphous creatures" },
          { id: "plants", name: "Plants", description: "Plant-like creatures" },
          { id: "undead", name: "Undead", description: "Zombies, ghosts, and vampires" },
          { id: "humanoids", name: "Humanoids", description: "People-like races, chosen separately" },
        ],
        humanoidChoices: {
          fields: [
