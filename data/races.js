...
DND_DATA.races = [
  ...
  },
  {
    ...
    flexibleAbilityIncreases: { choose: 2, amount: 1, exclude: ["Charisma"] },
    size: "Medium",
    speed: 30,
    senses: ["Darkvision 60 ft."],
    languages: ["Common", "Elvish"],
    languageChoices: { choose: 1, label: "Half-Elf Language" },
    traits: ["Darkvision", "Fey Ancestry", "Skill Versatility"],
    traitDetails: [
      "Ability Score Increase - Your Charisma score increases by 2, and two different other ability scores of your choice increase by 1.",
      "Darkvision - You can see in dim light within 60 feet as if it were bright light, and in darkness as if it were dim light.",
      "Fey Ancestry - You have advantage on saving throws against being charmed, and magic cannot put you to sleep.",
