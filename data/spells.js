...
DND_DATA.supportedSpellSelectionClasses = ["wizard", "cleric", "druid", "bard", "sorcerer", "warlock"];
...
DND_DATA.spellSelectionRules = {
  ...
  warlock: {
    sections: [
      { id: "cantrips", title: "Choose 2 Cantrips", helper: "Choose 2 Warlock cantrips.", level: 0, limit: 2 },
      { id: "spellbookSpells", title: "Known Spells", helper: "Choose 2 level 1 Warlock spells known. Patron spells give you additional options and are listed first.", level: 1, limit: 2 },
    ],
  },
  cleric: {
    sections: [
...
DND_DATA.warlockPatronExpandedSpells = {
  archfey: ["faerie-fire", "sleep"],
  fiend: ["burning-hands", "command"],
  "great-old-one": ["dissonant-whispers", "hideous-laughter"],
};
...
DND_DATA.spells = [
  ...
  { id: "blade-ward", name: "Blade Ward", level: 0, school: "Abjuration", castingTime: "1 action", range: "Self", components: "V, S", duration: "1 round", concentration: false, ritual: false, summary: "Briefly protect yourself against weapon damage.", classLists: ["wizard", "bard", "sorcerer", "warlock"] },
  { id: "chill-touch", name: "Chill Touch", level: 0, school: "Necromancy", castingTime: "1 action", range: "120 ft.", components: "V, S", duration: "1 round", concentration: false, ritual: false, summary: "A ghostly hand harms a creature and hinders healing.", classLists: ["wizard", "sorcerer", "warlock"] },
  ...
  { id: "eldritch-blast", name: "Eldritch Blast", level: 0, school: "Evocation", castingTime: "1 action", range: "120 ft.", components: "V, S", duration: "Instantaneous", concentration: false, ritual: false, summary: "Fire a beam of crackling force at a creature.", classLists: ["warlock"] },
  ...
  { id: "mage-hand", name: "Mage Hand", level: 0, school: "Conjuration", castingTime: "1 action", range: "30 ft.", components: "V, S", duration: "1 minute", concentration: false, ritual: false, summary: "Create a floating hand that can manipulate small objects.", classLists: ["wizard", "bard", "sorcerer", "warlock"] },
  ...
  { id: "minor-illusion", name: "Minor Illusion", level: 0, school: "Illusion", castingTime: "1 action", range: "30 ft.", components: "S, M", material: "A bit of fleece", duration: "1 minute", concentration: false, ritual: false, summary: "Create a small sound or image as a simple illusion.", classLists: ["wizard", "bard", "sorcerer", "warlock"] },
  { id: "poison-spray", name: "Poison Spray", level: 0, school: "Conjuration", castingTime: "1 action", range: "10 ft.", components: "V, S", duration: "Instantaneous", concentration: false, ritual: false, summary: "Spray poison at a nearby creature.", classLists: ["wizard", "druid", "sorcerer", "warlock"] },
  { id: "prestidigitation", name: "Prestidigitation", level: 0, school: "Transmutation", castingTime: "1 action", range: "10 ft.", components: "V, S", duration: "Up to 1 hour", concentration: false, ritual: false, summary: "Perform small magical tricks and harmless sensory effects.", classLists: ["wizard", "bard", "sorcerer", "warlock"] },
  ...
  { id: "true-strike", name: "True Strike", level: 0, school: "Divination", castingTime: "1 action", range: "30 ft.", components: "S", duration: "1 round", concentration: true, ritual: false, summary: "Study a target to help your next attack against it.", classLists: ["wizard", "bard", "sorcerer", "warlock"] },
  ...
  { id: "armor-of-agathys", name: "Armor of Agathys", level: 1, school: "Abjuration", castingTime: "1 action", range: "Self", components: "V, S, M", material: "A cup of water", duration: "1 hour", concentration: false, ritual: false, summary: "Cover yourself in frost that grants temporary hit points and punishes attackers.", classLists: ["warlock"] },
  { id: "arms-of-hadar", name: "Arms of Hadar", level: 1, school: "Conjuration", castingTime: "1 action", range: "Self", components: "V, S", duration: "Instantaneous", concentration: false, ritual: false, summary: "Unleash dark tendrils that harm nearby creatures and hinder reactions.", classLists: ["warlock"] },
  { id: "charm-person", name: "Charm Person", level: 1, school: "Enchantment", castingTime: "1 action", range: "30 ft.", components: "V, S", duration: "1 hour", concentration: false, ritual: false, summary: "Make a humanoid regard you as friendly for a while.", classLists: ["wizard", "druid", "bard", "sorcerer", "warlock"] },
  ...
  { id: "expeditious-retreat", name: "Expeditious Retreat", level: 1, school: "Transmutation", castingTime: "1 bonus action", range: "Self", components: "V, S", duration: "10 minutes", concentration: true, ritual: false, summary: "Move quickly by dashing as a bonus action.", classLists: ["wizard", "sorcerer", "warlock"] },
  ...
  { id: "hellish-rebuke", name: "Hellish Rebuke", level: 1, school: "Evocation", castingTime: "1 reaction", range: "60 ft.", components: "V, S", duration: "Instantaneous", concentration: false, ritual: false, summary: "Answer harm with a burst of fiery punishment.", classLists: ["warlock"] },
  { id: "hex", name: "Hex", level: 1, school: "Enchantment", castingTime: "1 bonus action", range: "90 ft.", components: "V, S, M", material: "The petrified eye of a newt", duration: "1 hour", concentration: true, ritual: false, summary: "Curse a creature so your attacks hurt more and one ability is hindered.", classLists: ["warlock"] },
  ...
  { id: "unseen-servant", name: "Unseen Servant", level: 1, school: "Conjuration", castingTime: "1 action", range: "60 ft.", components: "V, S, M", material: "A piece of string and a bit of wood", duration: "1 hour", concentration: false, ritual: true, summary: "Create an invisible servant that performs simple tasks.", classLists: ["wizard", "bard", "warlock"] },
  { id: "witch-bolt", name: "Witch Bolt", level: 1, school: "Evocation", castingTime: "1 action", range: "30 ft.", components: "V, S, M", material: "A twig from a tree struck by lightning", duration: "1 minute", concentration: true, ritual: false, summary: "Link lightning to a creature and keep hurting it while focused.", classLists: ["wizard", "sorcerer", "warlock"] },
...
DND_DATA.getWarlockPatronExpandedSpellIds = function getWarlockPatronExpandedSpellIds(patronId) {
  return DND_DATA.warlockPatronExpandedSpells[patronId] || [];
};

DND_DATA.getWarlockPatronExpandedSpells = function getWarlockPatronExpandedSpells(patronId) {
  return DND_DATA.getWarlockPatronExpandedSpellIds(patronId).map((spellId) => DND_DATA.getSpellById(spellId)).filter(Boolean);
};
...
DND_DATA.randomSpellSelectionForClass = function randomSpellSelectionForClass(classId, context = {}) {
  ...
  rules.sections.forEach((section) => {
    const limit = section.limit === "prepared"
      ...
      : section.limit;
    const baseOptions = DND_DATA.getSpellsForClassLevel(classId, section.level);
    const warlockExpandedOptions = classId === "warlock" && section.id === "spellbookSpells"
      ? DND_DATA.getWarlockPatronExpandedSpells(context.patronId)
      : [];
    const options = [...baseOptions, ...warlockExpandedOptions]
